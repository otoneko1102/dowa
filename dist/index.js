// src/lib/regex.ts
var regexStrict = /(?:\u{1F605}|\u{1F923}|\u{203C}\u{FE0F}?|(?:[きキｷ][ちチﾁ]|[おぉオォｵｫ][うぅウゥｳｩ]|[うぅウゥｳｩ][おぉオォｵｫ]|[どドﾄﾞ][わゎワヮ])[-ｰー～っッｯ]*(?:[wｗ]+|(?:(?:爆笑)|笑)+|[（(]笑[）)] )|(?:爆笑){2,}|(?:冷笑){2,}|[（(]笑[）)])/gu;
var relaxedOnly = /(?:[うぅウゥｳｩ][おぉオォｵｫ]|[どドﾄﾞ][わゎワヮ])[-ｰー～っッｯ]*|爆笑|冷笑|(?:\u{1F4A6})/gu;
